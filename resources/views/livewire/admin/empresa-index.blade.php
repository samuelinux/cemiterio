<div x-data
    ...
    <div class="mb-4 grid grid-cols-1 md:grid-cols-4 gap-3">
        <div class="md:col-span-2">
            <input type="text" placeholder="Pesquisar (nome, e-mail, cidade, estado)..."
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Cidade/UF</th>
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($empresas as $empresa)
                    <tr>
                        <td class="px-4 py-2 text-sm text-gray-700">{{ $empresa->id }}</td>
                        <td class="px-4 py-2 text-sm text-gray-900 font-medium">{{ $empresa->nome }}</td>
                        <td class="px-4 py-2 text-sm text-gray-700">{{ $empresa->email }}</td>
                        ...
                        <td class="px-4 py-2 text-right space-x-2">
                            ...
                            <button type="button" wire:click="confirmDelete({{ $empresa->id }})"
