...
trait WithSepultamentoCrud
{
    ...
    private function preencherFormulario(Sepultamento $sepultamento): void
    {
        ...
        $this->data_falecimento = $sepultamento->data_falecimento ? $sepultamento->data_falecimento : null;
        $this->data_sepultamento = $sepultamento->data_sepultamento ? $sepultamento->data_sepultamento : null;
